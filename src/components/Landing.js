    ...
    return (
        ...
        <div style={{ display:'flex', flexDirection:'column', alignItems:'center'}}>
            ...
            <div style={{marginBottom:0, marginTop:20, maxWidth:900, width:'100%', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center'}}>
                        ...
                        <Avatar  sx={{ width: 150, height: 150 }} style={{marginRight:15}} src={david} />
            ...
            <div style={{marginTop:50, maxWidth:900, width:'100%'}}>
                ...
                <div class='profile-card' style={{display:'flex', flexDirection:'column', backgroundColor:'#081424', borderRadius:10, padding:20}}>
                    <div style={{display:'flex', flexDirection:'row', alignItems:'center',  borderRadius:10}} >
                        ...
                        <div style={{display:'flex', marginLeft:15, flexDirection:'column', justifyContent:'flexStart'}}>
                            <p style={{fontWeight:'normal', color:'white', fontSize:16, }} ><b>Amped Chess LLC</b> <br/> Win money playing chess <br/> Esports</p>
                        </div>
                    </div>
                ...
                <div class='profile-card' style={{marginTop:20, display:'flex', flexDirection:'column', backgroundColor:'#081424', borderRadius:10, padding:20}}>
                    <div style={{display:'flex', flexDirection:'row', alignItems:'center',  borderRadius:10}} >
                        ...
                        <div style={{display:'flex', marginLeft:15, flexDirection:'column', justifyContent:'flexStart'}}>
                            <p style={{fontWeight:'normal', color:'white', fontSize:16, }} ><b>Amped Trading LLC</b> <br/> Win money playing chess <br/> Esports</p>
                        </div>
                    </div>
                        <p style={{color:'white', fontSize:14}}>
                ...
                <p style={{marginTop:50,  color:'white', textAlign:'left',  margin:0, padding:0, marginBottom:10,  fontWeight:'bold', fontSize:20}}>Professional Experience</p>
                ...
                <p style={{marginTop:50, textAlign:'left',  margin:0, padding:0, marginBottom:10, color:'white',  fontWeight:'bold', fontSize:20}}>Education</p>
